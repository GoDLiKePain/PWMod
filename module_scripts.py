   ...
   [(store_script_param, ":player_id", 1),  # must be valid
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        animation_menu_entry("str_anim_lute_1", animation="anim_play_lute", man_sound="snd_lute_1",woman_sound="snd_lute_1", music=2, instrument="itm_lute", max_distance=400),
        animation_menu_entry("str_anim_lute_2", animation="anim_play_lute", man_sound="snd_lute_2", woman_sound="snd_lute_2", music=2, instrument="itm_lute" max_distance=400),
        animation_menu_entry("str_anim_lute_3", animation="anim_play_lute", man_sound="snd_lute_3",woman_sound="snd_lute_3", music=2, instrument="itm_lute" max_distance=400),
        animation_menu_entry("str_anim_lute_4", animation="anim_play_lute", man_sound="snd_lute_4",woman_sound="snd_lute_4", music=2, instrument="itm_lute" max_distance=400),
        animation_menu_entry("str_anim_lyre_1", animation="anim_play_lyre", man_sound="snd_lyre_1",woman_sound="snd_lyre_1", music=3, instrument="itm_lyre" max_distance=400),
        animation_menu_entry("str_anim_lyre_2", animation="anim_play_lyre", man_sound="snd_lyre_2",woman_sound="snd_lyre_2", music=3, instrument="itm_lyre" max_distance=400),
        animation_menu_entry("str_anim_lyre_3", animation="anim_play_lyre", man_sound="snd_lyre_3",woman_sound="snd_lyre_3", music=3, instrument="itm_lyre" max_distance=400),
        animation_menu_entry("str_anim_lyre_4", animation="anim_play_lyre", man_sound="snd_lyre_4",woman_sound="snd_lyre_4", music=3, instrument="itm_lyre" max_distance=400),
